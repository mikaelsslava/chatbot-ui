...
AS $$
DECLARE
  project_url TEXT := 'https://nbjcnfinceghbinrhprf.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5iamNuZmluY2VnaGJpbnJocHJmIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyOTY5MzQwMCwiZXhwIjoyMDQ1MjY5NDAwfQ.ix3OMWSBbcEUpYm3HxGM5LEtndMZJHItd8ncSy-BZzs'; -- full access needed for http request to storage
